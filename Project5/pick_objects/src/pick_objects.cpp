...
// SECOND GOAL
    // Define a position and orientation for the robot to dropoff
  goal.target_pose.pose.position.x = -1.5;
  goal.target_pose.pose.position.y = 2.0;
  goal.target_pose.pose.orientation.w = 3.5;

   // Send the goal position and orientation for the robot to reach
  ROS_INFO("Sending Second Goal: Go to Dropoff zone...");
  ac.sendGoal(goal);
